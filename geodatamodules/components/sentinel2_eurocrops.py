...
from geodatasets import EuroCrops, Sentinel2, random_grid_cell_assignment
from samplers import GridGeoSampler, RandomBatchGeoSampler
from samplers.utils import _to_tuple
from transforms import AugmentationSequential
from geodatamodules.geo import GeoDataModule


class Sentinel2EuroCropsDataModule(GeoDataModule):
    """LightningDataModule implementation for the EuroCrops and Sentinel2 geodatasets.
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            **kwargs: Additional keyword arguments passed to
                :class:`~torchgeo.geodatasets.EuroCrops` (prefix keys with ``eurocrops_``)
                and :class:`~torchgeo.geodatasets.Sentinel2`
    ...
    def setup(self, stage: str) -> None:
        """Set up geodatasets and samplers.

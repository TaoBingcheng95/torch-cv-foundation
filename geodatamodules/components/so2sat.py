...
from geodatasets import So2Sat
...
class So2SatDataModule(NonGeoDataModule):
    ...
    If using the version 3 geodatasets, we use a random 80/20 train/val split from the
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            val_split_pct: Percentage of training data to use for validation in with
                the version 3 geodatasets.
            **kwargs: Additional keyword arguments passed to
                :class:`~torchgeo.geodatasets.So2Sat`.

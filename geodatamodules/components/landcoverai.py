...
"""LandCover.ai geodatamodules."""

from typing import Any

import kornia.augmentation as K

from geodatasets import LandCoverAI, LandCoverAI100
    ...
    def __init__(
        ...
        Args:
            ...
            **kwargs: Additional keyword arguments passed to
                :class:`~torchgeo.geodatasets.LandCoverAI`.
        """
...
class LandCoverAI100DataModule(NonGeoDataModule):
    ...
    def __init__(
        ...
        Args:
            ...
            num_workers: Number of workers for parallel data loading.
            **kwargs: Additional keyword arguments passed to
                :class:`~torchgeo.geodatasets.LandCoverAI100`.
        """

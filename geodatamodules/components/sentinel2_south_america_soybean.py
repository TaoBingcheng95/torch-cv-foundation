...
from geodatasets import Sentinel2, SouthAmericaSoybean, random_grid_cell_assignment
...
class Sentinel2SouthAmericaSoybeanDataModule(GeoDataModule):
    """LightningDataModule for SouthAmericaSoybean and Sentinel2 geodatasets.
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            **kwargs: Additional keyword arguments passed to
                :class:`~torchgeo.geodatasets.SouthAmericaSoybean`
                (prefix keys with ``south_america_soybean_``) and
                :class:`~torchgeo.geodatasets.Sentinel2`

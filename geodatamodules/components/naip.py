...
class NAIPChesapeakeDataModule(GeoDataModule):
    """LightningDataModule implementation for the NAIP and Chesapeake geodatasets.
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            **kwargs: Additional keyword arguments passed to
                :class:`~torchgeo.geodatasets.NAIP` (prefix keys with ``naip_``) and
                :class:`~torchgeo.geodatasets.Chesapeake`

...
from geodatasets.components import DigitalTyphoon
from geodatasets.components.digital_typhoon import _SampleSequenceDict
from geodatamodules.geo import NonGeoDataModule
from geodatamodules.utils import group_shuffle_split
...
class DigitalTyphoonDataModule(NonGeoDataModule):
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            **kwargs: Additional keyword arguments passed to
                :class:`~torchgeo.geodatasets.DigitalTyphoon`.
    ...
    def _split_dataset(
        ...
        Returns:
            a tuple of the subset geodatasets
        """

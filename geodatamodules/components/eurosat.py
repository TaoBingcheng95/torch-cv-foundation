...
from geodatasets.components import EuroSAT, EuroSAT100, EuroSATSpatial
    ...
    def __init__(
        ...
        Args:
            ...
            **kwargs: Additional keyword arguments passed to
                :class:`~torchgeo.geodatasets.EuroSAT`.
        """
...
class EuroSATSpatialDataModule(NonGeoDataModule):
    ...
    def __init__(
        ...
        Args:
            ...
            num_workers: Number of workers for parallel data loading.
            **kwargs: Additional keyword arguments passed to
                :class:`~torchgeo.geodatasets.EuroSATSpatial`.
        """
        bands = kwargs.get('bands', EuroSAT.all_band_names)
...
class EuroSAT100DataModule(NonGeoDataModule):
    ...
    def __init__(
        ...
        Args:
            ...
            num_workers: Number of workers for parallel data loading.
            **kwargs: Additional keyword arguments passed to
                :class:`~torchgeo.geodatasets.EuroSAT100`.
        """
        bands = kwargs.get('bands', EuroSAT.all_band_names)
        self.mean = torch.tensor([MEAN[b] for b in bands])
        self.std = torch.tensor([STD[b] for b in bands])

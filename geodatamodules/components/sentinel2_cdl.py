...
from geodatasets import CDL, Sentinel2, random_grid_cell_assignment
...
class Sentinel2CDLDataModule(GeoDataModule):
    """LightningDataModule implementation for the Sentinel-2 and CDL geodatasets.
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            **kwargs: Additional keyword arguments passed to
                :class:`~torchgeo.geodatasets.CDL` (prefix keys with ``cdl_``) and

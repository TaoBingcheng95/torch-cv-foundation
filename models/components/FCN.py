...
class FCN8s(nn.Module):
    def __init__(self, num_classes):
        ...
        self.pretrained_net = models.resnet34(pretrained=True)
...
class FCN8x(nn.Module):
    def __init__(self, num_classes):
        ...
        self.stage1 = nn.Sequential(*list(self.pretrained_model.children())[:-4])  # 第一段
        self.stage2 = list(self.pretrained_model.children())[-4]  # 第二段
        self.stage3 = list(self.pretrained_model.children())[-3]  # 第三段

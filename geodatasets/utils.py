...
from geodatasets.errors import DependencyNotFoundError
...
def concat_samples(samples: Iterable[Mapping[Any, Any]]) -> dict[Any, Any]:
    ...
    Useful for joining samples in a :class:`torchgeo.geodatasets.IntersectionDataset`.
...
def merge_samples(samples: Iterable[Mapping[Any, Any]]) -> dict[Any, Any]:
    ...
    Useful for joining samples in a :class:`torchgeo.geodatasets.UnionDataset`.
...
$ pip install torchgeo[geodatasets]

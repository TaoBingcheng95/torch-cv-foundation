...
from geodatasets.utils import Path, check_integrity, download_url, extract_archive


class SSL4EO(NonGeoDataset):
    """Base class for all SSL4EO geodatasets.

    Self-Supervised Learning for Earth Observation (SSL4EO) is a collection of
    large-scale multimodal multitemporal geodatasets for unsupervised/self-supervised

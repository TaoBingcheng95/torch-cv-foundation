...
from geodatasets.errors import DatasetNotFoundError, RGBBandsMissingError
from geodatasets.geo import NonGeoDataset
from geodatasets.utils import Path, check_integrity, lazy_import, percentile_normalization
...
class So2Sat(NonGeoDataset):
    ...
    * https://doi.org/10.1109/MGRS.2020.2964708
    ...
    .. note::
       ...
       The version 3 geodatasets can be downloaded using the following bash script:

...
from geodatasets.geo import NonGeoClassificationDataset
from geodatasets.utils import Path, check_integrity, download_url, extract_archive, rasterio_loader

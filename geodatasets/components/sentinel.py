...
from geodatasets.errors import RGBBandsMissingError
from geodatasets.geo import RasterDataset
from geodatasets.utils import Path


class Sentinel(RasterDataset):
    """Abstract base class for all Sentinel geodatasets.

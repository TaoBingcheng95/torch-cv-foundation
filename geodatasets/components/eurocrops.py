...
from geodatasets.geo import VectorDataset
from geodatasets.utils import Path, check_integrity, download_and_extract_archive, download_url
...
class EuroCrops(VectorDataset):
    ...
    publicly available self-declared crop reporting geodatasets from countries of the

...
from geodatasets.geo import NonGeoDataset
...
class SpaceNet(NonGeoDataset, ABC):
    """Abstract base class for the SpaceNet geodatasets.

    The `SpaceNet <https://spacenet.ai/datasets/>`__ geodatasets are a set of
    geodatasets that all together contain >11M building footprints and ~20,000 km
    ...
    .. note::
       ...
       The SpaceNet geodatasets require the following additional library to be installed:

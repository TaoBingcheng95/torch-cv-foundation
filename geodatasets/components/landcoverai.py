...
from geodatasets.geo import NonGeoDataset, RasterDataset
from geodatasets.utils import BoundingBox, Path, download_url, extract_archive, working_dir


class LandCoverAIBase(Dataset[dict[str, Any]], abc.ABC):
    r"""Abstract base class for LandCover.ai Geo and NonGeo geodatasets.

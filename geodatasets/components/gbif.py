...
from geodatasets.geo import GeoDataset
from geodatasets.utils import BoundingBox, Path
...
def _disambiguate_timestamps(
    ...
    Based on :func:`torchgeo.geodatasets.utils.disambiguate_timestamps`.
...
class GBIF(GeoDataset):
    ...
    work for other GBIF `geodatasets <https://www.gbif.org/dataset/search>`_. Data for a

...
"""LEVIR-CD and LEVIR-CD+ geodatasets."""
...
from geodatasets.utils import Path, download_and_extract_archive, percentile_normalization


class LEVIRCDBase(NonGeoDataset, abc.ABC):
    """Abstract base class for the LEVIRCD geodatasets.

...
from geodatasets.utils import Path, check_integrity, download_and_extract_archive
...
# TODO: add COCW-M geodatasets:
#
# * https://gdo152.llnl.gov/cowc/download/cowc-m/datasets/
# * https://github.com/LLNL/cowc
#
# Same as COCW geodatasets, but instead of binary classification there are 4 car classes:
#
# 1. Sedan
# 2. Pickup
# 3. Other

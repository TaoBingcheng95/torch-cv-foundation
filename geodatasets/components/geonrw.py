...
from geodatasets.utils import Path, download_and_extract_archive, extract_archive


class GeoNRW(NonGeoDataset):
    """GeoNRW dataset.

    This geodatasets contains RGB, DEM and segmentation label data from North Rhine-Westphalia, Germany.

...
from geodatasets.geo import RasterDataset
from geodatasets.utils import BoundingBox, Path, which
...
class SouthAfricaCropType(RasterDataset):
    ...
    timeseries geodatasets, the first available imagery in July will be returned for each

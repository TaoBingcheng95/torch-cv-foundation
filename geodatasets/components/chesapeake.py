...
"""Cheasapeake Bay Program Land Use/Land Cover Data Project geodatasets."""
...
from geodatasets.geo import GeoDataset, RasterDataset
from .nlcd import NLCD
from geodatasets.utils import BoundingBox, Path, download_url, extract_archive


class Chesapeake(RasterDataset, ABC):
    """Abstract base class for all Chesapeake geodatasets.
